...
1. How would you describe preprocessing to someone new to CSS?
    ...
    It is a tool that allows you to write more DRY css. It allows variables and functions like javascript, to allow for greater reuseablility.

2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?

    My favorite concept is variables. the concept that gave me the most trouble is nesting. 

3. How would you explain the concept of a variable to someone new to programming?

    A variable is a digital box that can hold a value, many values or instructions.

4. What is the purpose of using functions in code?

    The purpose is to have a reuseable set of instructions that dont have to be rewritten.

5. What is a JSON data?

    JSON is JavaScript object notation, it is a format for structuring data. 
